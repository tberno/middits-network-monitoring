...
headers = {"Content-Type": "application/json", "X-Requested-By": "python-beat-the-fold"}

# Compressed strictly to 5 lines to permanently kill the "Show more" button
nms_template = (
    "${if event.is_resolved}🟢 *RESOLVED*${else}🔴 *TRIGGERED*${end} | *Severity:* Priority ${event.priority}\n"
...
print("SUCCESS: 5-Line limit applied. Triggering test...")
os.system("logger -n 127.0.0.1 -P 514 'LACP_INTF_DOWN: ae77: Testing the 5-line limit'")
