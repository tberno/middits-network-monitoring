...
headers = {"Content-Type": "application/json", "X-Requested-By": "python-fluff-killer"}

# The exact LibreNMS vertical layout
nms_template = (
...
data["config"]["include_title"] = False # THIS KILLS THE GRAYLOG TITLE
...
print("SUCCESS: Fluff removed. Triggering final test...")
os.system("logger -n 127.0.0.1 -P 514 'LACP_INTF_DOWN: ae77: Testing final stripped layout'")
